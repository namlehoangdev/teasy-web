...
const LOGIN_WITH_FACEBOOK = 'Đăng nhập Facebook';
const LOGIN_WITH_GOOGLE = 'Đăng nhập Google';
const GOTO_ADMIN_PAGE = 'Giáo viên, tổ chức';
const GOTO_PLAYGROUND = 'Thí sinh dự thi';
