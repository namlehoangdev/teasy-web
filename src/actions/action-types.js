...
export const GET_ANONYMOUS_CONTEST_METADATA_BY_CODE = 'GET_ANONYMOUS_CONTEST_METADATA_BY_CODE';
export const GET_MARKED_CONTEST_RESULT = 'GET_MARKED_CONTEST_RESULT';
export const GET_MARKED_ANONYMOUS_CONTEST_RESULT = 'GET_MARKED_ANONYMOUS_CONTEST_RESULT';
...
export const UPDATE_PARTITION_OF_CONTEST_BY_ID = 'UPDATE_PARTITION_OF_CONTEST_BY_ID';
export const UPDATE_OWN_CONTEST_RESULT_BY_ID = 'UPDATE_OWN_CONTEST_RESULT_BY_ID';
